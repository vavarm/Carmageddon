...
public class Compiler {
    ...
    public static void main(String[] args) {
        ...
        getCompilFiles(toBeCompiledDir, files);

        // create the router
        createRouter(calculationFile, files);

        // for each file, read the content,
        // create a method
        // and write it in the file named "Calculation" before the last 
        writeMethodToFile(calculationFile, files);

        // close the Calculation class
        closeClass(calculationFile);
    }
    ...
    static void getCompilFiles(Path toBeCompiledDir, List<Path> files) {
    ...
    static void createRouter(Path calculationFile, List<Path> files) {
    ...
    static void writeMethodToFile(Path calculationFile, List<Path> files){
        for (Path file : files) {
            String fileName = file.getFileName().toString().replace(DOT_COMPIL, "");
            try {
    ...
    static void closeClass(Path calculationFile){
        String finalContent = "}\n";
        try {
